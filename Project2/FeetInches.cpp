...
/*
Description: This function takes a string holding a Feet'Inches" and converts to int class members
Parameters: a string holding the height
*/
void FeetInches::setLength(string h){
	feet = atoi((h.substr(0, h.find("'"))).c_str());
	h = h.substr(h.find("'")+1);
	inches = atoi((h.substr(0, h.find('"'))).c_str());
}
...
/*
Description: this function overloads the to string function to print the feet and inches
return: a string
*/
