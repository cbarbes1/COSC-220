...
*   Description: <The expressed purpose of this program is to create a random number array. 
*                 Which will ask the user to enter the amount of numbers and the range.>
...
int main()
{
    ...
    if(printVerif=='Y'||printVerif=='y')
    {
        ...
        cout<<endl;
        //count and while loop to print using dereferencing
        int count = 0;
        while(!(count==size))
        {
            cout<<*(randomUserArray+count)<<" ";
            count++;
        }
        cout<<endl;
    }
